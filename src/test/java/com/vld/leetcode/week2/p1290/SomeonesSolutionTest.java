...
public class SomeonesSolutionTest {
    SomeonesSolution someonesSolution;
    ListNodeUtil listNodeUtil = new ListNodeUtil();

    @BeforeEach
    void setup() {
        someonesSolution = new SomeonesSolution();
    }
    ...
    void test1() {
        ...
        int actual = someonesSolution.getDecimalValue(listNode);
    ...
    void test6() {
        ...
        int actual = someonesSolution.getDecimalValue(node);
