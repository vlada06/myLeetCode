...
public class GoalParserInterpreterWhileLoopTest {
    GoalParserInterpreterWhileLoop goalParserInterpreter;

    @BeforeEach
    void setUp() {
        goalParserInterpreter = new GoalParserInterpreterWhileLoop();
    }
