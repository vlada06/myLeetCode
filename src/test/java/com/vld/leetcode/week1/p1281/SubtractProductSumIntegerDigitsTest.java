...
public class SubtractProductSumIntegerDigitsTest {
    SubtractProductSumIntegerDigits subtractProductSumIntegerDigits;

    @BeforeEach
    void setup() {
        subtractProductSumIntegerDigits = new SubtractProductSumIntegerDigits();
    }
